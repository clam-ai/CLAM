...
TEST_DIR = os.path.join(BASE_DIR, "compiler/tests/glue")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--should_pad", action="store_true", help="Should pad (for gemma, not for T5)"
    )
    ...
    parser.add_argument(
        "--train_head",
        action="store_true",
        help="Train head (for experiment 2, not for T5)",
    )
